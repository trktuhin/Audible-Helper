...
namespace AudibleHelper.API.Data
{
    public interface IAudibleRepository
    {
         ...
         Task<List<Review>> GetReviewsForDelete(ReviewParams revParams);
         ...
         Task<List<Message>> GetMessagesForDelete(DeleteDto messageParams);
         ...
         int GetUnreadMessageCount(int id);
    }
}